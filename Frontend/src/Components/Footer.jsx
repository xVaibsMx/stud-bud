...
const Footer = () => {
  return (
    <footer className="bg-[#0b1224] text-gray-300 py-12 mt-16 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-8">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-gray-400 max-w-xs">
            ...
            assistant built using the MERN Stack and Gemini API. Whether you’re
            preparing for exams or revising quickly, Stud-Bud has your back with
            bite-sized explanations, quizzes, and revision tools — all tailored
            to your needs.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-4 mt-1">
            ...
            <motion.a
              whileHover={{ scale: 1.2 }}
              href="https://linkedin.com/in/xVaibsMx"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-teal-400 transition"
            >
      ...
      <div className="mt-12 text-center text-gray-500 text-sm border-t border-white/10 pt-6 flex flex-col gap-2">
        <span>
